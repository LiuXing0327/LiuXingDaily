...
class DailyLabelAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var categorizedList: List<Any> = ArrayList()
    private var headerYearMonth: Boolean = true
    ...
    fun setDailyList(
        ...
        val filter = sortedByDescending.filter {
            it.value.dailyLabel == dailyLabel
        }
